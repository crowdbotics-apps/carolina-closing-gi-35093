...
## Project Structure
    ...
    ├── carolina_closing_gi_35093  # Django project configurations
...
1. Clone this repo and `cd carolina_closing_gi_35093`
...
2. Clone this repo and `cd carolina_closing_gi_35093`
